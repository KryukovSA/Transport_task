...
//    int electric_count = 0;//количество не более половины числа потербителей например
//    int flag = 1;// 1 - из табл тарифы     0 - автогенерация
//    method_potencials.set_countSuppliers(100);
//    method_potencials.set_countConsumers(110);
//
//
...
//        }
//    }
//    method_potencials.showPostavki();
//    method_potencials.showEstimation();
//
//    //method_potencials.method_potentials_init(flag, 8, main_matrix);
